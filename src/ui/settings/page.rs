...
///
/// Upstream `v0.3.5` dropped this control ("one less control to maintain") but
/// kept the stored accent and the code that applies it. This fork keeps the
/// control: the accent is a feature in active use here, and without the row the
/// stored color could never be changed from the UI again.
